...
export default function PurchaseForm() {
    ...
    return (
        ...
        //                     id="searchSymbol"
        //                     onChange={handleInputChange} />
        //                 <div id="previewPrice" className="form-text text-muted">Preview current price here{currentPrice}</div>
        //             </div>
        //         </div>
        //         <div className="form-group row">
        ...
        //                 <div id="previewTotal" className="form-text text-muted">Preview TX total here{calculateTotal()}</div>
        //             </div>
        //         </div>
